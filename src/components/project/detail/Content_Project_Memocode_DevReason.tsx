...
const Content_Project_Memocode_DevReason = () => {
    return (
        <div className="flex flex-col w-full h-fit bg-zinc-900/70 rounded p-3 sm:p-5">
            ...
            <div className="pt-5 tracking-wide space-y-5 text-zinc-300">
                ...
                <div>
                    <div className="flex text-[14px] items-center font-semibold leading-7">
                        <CiStickyNote className="w-6 h-6 mr-1"/>
                        메모
                    </div>
                    <div className="text-[13px] leading-7">
                        저는 평소 중요한 아이디어나 정보를 놓치지 않고 기억하기 위해 메모를 자주하는 습관이 있습니다.
                    </div>
                    <div className="text-[13px] leading-7">메모하는 습관은 개발과정에서도 큰 도움이 되었습니다.</div>
                    <div className="text-[13px] leading-7">
                ...
                <div>
                    <div className="flex text-[14px] items-center font-semibold leading-7">
                        <div className="font-bold text-xl mr-1.5">B</div>
                        블로그 관리
                    </div>
                    <div className="text-[13px] leading-7">
                ...
                <div>
                    <div className="flex items-center font-semibold leading-7">
                        <MdOutlineQuestionAnswer className="w-5 h-5 mr-1.5"/>
...
export default Content_Project_Memocode_DevReason;