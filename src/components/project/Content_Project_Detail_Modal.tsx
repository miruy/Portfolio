                    ...
                    <div className="flex justify-center py-5 space-x-1 items-center">
                        {!url &&
                            <div className="flex flex-col space-y-1">
                                <div
                                    className="flex items-start space-x-1.5 text-red-500 font-semibold text-[14px] md:text-[15px]">
                                ...
                                <div
                                    ...
                                    <FaAsterisk className="flex-shrink-0 mt-1.5 w-2.5 h-2.5"/>
                                    <div>
                                        저작권 및 관련 정보 보호를 위해 프로젝트 전체가 아닌 일부만<span className=" text-[13px]"> (예:이미지 블라인드 처리, 구현 기능 등) </span>게시하는
                                        점 양해 부탁드립니다.
                                    </div>
                                </div>
                            </div>
