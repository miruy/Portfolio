...
const Profile = () => {
    ...
    return (
        <div
                ...
                <div className="flex flex-col w-[200px] md:w-full items-center justify-center space-y-1">
                    ...
                    <div className="flex w-full space-x-1">
                        <div className="flex flex-col flex-1 items-center mb-1">
                            ...
                            >
                                <FaGithub className="w-7 h-7 xl:w-8 xl:h-8 mt-1 fill-zinc-500 hover:fill-foreground hover:scale-105"/>
                            </Link>
                        </div>
            ...
            <div
                className="flex flex-col h-fit leading-6 space-y-1.5 tracking-wide p-5 text-sm xl:text-[17px] text-secondary-foreground">
                <div>안녕하세요.</div>
                <div>
                    프론트엔드 개발자가 되고자
                    <span className="text-foreground font-semibold"> 끊임없는 공부</span>
                    와
                    <span className="text-foreground font-semibold"> 지속적인 실전 경험</span>
                    을 쌓기 위해 노력하고 있는
                    <span className="text-foreground font-bold"> 김유림 </span>
                    입니다.
                </div>
                <div>
                    백엔드 개발자 양성과정을 통해 기초를 다진 후, 현재는
                    <span className="text-foreground font-semibold"> 사용자 중심의 인터페이스를 구축</span>
                    하는 프론트엔드 개발에
                    집중하고 있습니다.
                </div>
            </div>
